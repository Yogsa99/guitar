...
from src.utilities import audio_util as au
from src.utilities import features_util as fu
from sklearn.preprocessing import LabelEncoder
import numpy as np

from train_and_save_model import create_and_save_model
...
def predict_chord(chroma_type="cqt", model="kernel_svm"):
    ...
    encoder.classes_ = np.load(saved_label_encoder,allow_pickle=True)
